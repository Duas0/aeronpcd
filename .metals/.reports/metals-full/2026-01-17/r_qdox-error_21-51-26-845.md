error id: file:///C:/PCD_Tercero/AERON/AERON/aeronpcd/aeronpcd/src/main/Main.java
file:///C:/PCD_Tercero/AERON/AERON/aeronpcd/aeronpcd/src/main/Main.java
...
```java
offset: 25
uri: file:///C:/PCD_Tercero/AERON/AERON/aeronpcd/aeronpcd/src/main/Main.java
text:
```scala
package main;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 2. Inicializar Torre (Modo Concurrente)
        ControlTowerConcurrent tower = new ControlTowerConcurrent(numPistas, numPuertas, ventana);
        ventana.setTower(tower);
        ventana.updateResources();

        System.out.println("Iniciando simulación AERON con " + numAviones + " aviones...");
        ...
        for (int i = 1; i <= numAviones; i++) {
            ...
            p.start();
            try {
                // Pequeña pausa para escalonar llegadas iniciales
                Thread.sleep(200);
...
QDox parse error in file:///C:/PCD_Tercero/AERON/AERON/aeronpcd/aeronpcd/src/main/Main.java